...
export function StreamTab({ onUserSelect, onChatWithUser }: StreamTabProps) {
    ...
    return (
      <div className="max-w-lg mx-auto animate-fade-in">
        ...
        <div className="text-center py-12">
          ...
          <p className="text-zinc-400 text-lg">No photos in the stream yet</p>
          <p className="text-zinc-500 mt-2">Be the first to share!</p>
        </div>
      </div>
    );
  }
